...
class FragmentTwo : Fragment() {
    lateinit var listener: FragmentOne.tableListener
    ...
    override fun onCreateView(
        ...
        (parentActivity as TablesActivity).fragmentTwo = this
        // Inflate the layout for this fragment
        val view: View =  inflater.inflate(R.layout.outdoor_plan, container, false)
        getTables(view)
        // Add Listener for showReservationButton
        view.findViewById<Button>(R.id.showAllReservationsOutdoor).setOnClickListener {
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as FragmentOne.tableListener
    }
